...
export class AnalyticsEventsExtras1711000000061 implements MigrationInterface {
  name = 'AnalyticsEventsExtras1711000000061';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(`
      ALTER TABLE "analytics_events" DROP COLUMN IF EXISTS "context"
    `);
    await queryRunner.query(`
      ALTER TABLE "analytics_events" DROP COLUMN IF EXISTS "source"
    `);
    await queryRunner.query(`

...
@Controller('arena/cricket-indoor')
@UseGuards(RolesGuard)
export class CricketIndoorController {
  constructor(private readonly service: CricketIndoorService) {}
  ...
  create(
    @CurrentTenant() tenant: TenantContext,
    @Body() dto: CreateCricketIndoorCourtDto,
  ) {
  ...
  patch(
    @CurrentTenant() tenant: TenantContext,
    @Param('id', ParseUUIDPipe) id: string,
    @Body() dto: UpdateCricketIndoorCourtDto,
  ) {
